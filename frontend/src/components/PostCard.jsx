...
import { ThumbsUpIcon, MessageCircleIcon, BookmarkIcon } from "./Icons";

export default function PostCard({ post, showActions = false, onLike, onDislike, onFavorite, onDelete, canEdit = false }) {
  const tagList = (post.tags || "").split(",").filter(Boolean).map((t) => t.trim());
