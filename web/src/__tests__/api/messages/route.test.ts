...
describe("Messages API", () => {
  ...
  it("GET /api/messages filters out conversations for deleted users", async () => {
  ...
  it("POST /api/messages returns 401 when unauthenticated", async () => {
  ...
  it("POST /api/messages returns conversation id on success", async () => {
  ...
  it("POST /api/messages returns 404 when receiver does not exist", async () => {
    mockVerifyAuth.mockResolvedValue({ username: "alice" });
